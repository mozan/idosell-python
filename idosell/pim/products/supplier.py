...
from idosell._common import AppendableGateway
from idosell.pim.products._common import ProductsSupplierPutCodeModel, ProductsSupplierPutProductDataModel
