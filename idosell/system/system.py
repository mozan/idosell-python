...
from idosell._common import AppendableGateway, Gateway
from idosell.system._common import CurrenciesModel, OrdersModel, PanelSettingsModel, UnitsModel, UserTypeEnum
...
class GetCurrencies(Gateway):
    ...
    symbol: str = Field(..., description="Currency symbol in ISO 4217 format")
