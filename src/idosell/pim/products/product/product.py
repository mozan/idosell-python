...
class SearchPimProductsProductProductParamsModel(BaseModel):
    ...
    productLocationTextId: str | None = Field(None, description=r"Warehouse location full path. Use a backslash () as a separator, for example: M1\Section name\Location name. If location_id parameter is provided, the full warehouse location path will not be taken into account") # type: ignore
