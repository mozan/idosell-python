...
class SearchEmailCrmNewsletterParamsModel(BaseModel):
    ...
    return_elements: list[str] | None = Field(default=None, min_length=1, description="Elements to be returned by the endpoint. By default all elements are returned")
